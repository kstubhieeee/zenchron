...
export function TaskInputNoAuth({ onTasksCreated }: TaskInputProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/tasks-noauth/categorize', {
        method: 'POST',
      ...
      for (const task of data.tasks) {
        ...
        const createResponse = await fetch('/api/tasks-noauth', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
      ...
      <CardContent className="p-4">
        <div className="space-y-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-semibold text-gray-900">Add Tasks with AI (Test Mode)</h3>
          </div>
