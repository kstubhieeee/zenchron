...
export async function POST(request: NextRequest) {
    try {
        ...
        console.log("Received Google Meet transcript webhook:", {
        ...
        // For now, we'll use a default user email since the webhook comes from the extension
        // In a production setup, you might want to include user identification in the webhook
        const userEmail = request.headers.get('x-user-email') || 'user@zenchron.com';
